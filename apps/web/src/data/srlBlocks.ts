...
export const GROUPS: GroupMeta[] = [
  ...
  {
    key: "produtoMercado",
    name: "Produto e Mercado",
    subtitle: "II. Product/Market Fit",
    detailTitle: "II. PRODUTO E MERCADO",
    conceptualFocus:
  ...
  {
    key: "escala",
    name: "Sustentabilidade e Escala",
    subtitle: "III. Scalability Fit",
    detailTitle: "III. SUSTENTABILIDADE E ESCALA",
    conceptualFocus:
  ...
  {
    key: "governanca",
    name: "Futuro e Governança",
    subtitle: "IV. Futuro e Governança",
    detailTitle: "IV. FUTURO E GOVERNANÇA",
    conceptualFocus:
